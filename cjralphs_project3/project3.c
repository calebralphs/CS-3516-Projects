...
// prints the 'mincost' for a RoutePacket struct
void print_mincost(struct RoutePacket *rcvdpkt) {
  printf("               changed mincost list for route packet: [");
  printf("%d, ", rcvdpkt->mincost[0]);
  printf("%d, ", rcvdpkt->mincost[1]);
  printf("%d, ", rcvdpkt->mincost[2]);
  printf("%d].\n", rcvdpkt->mincost[0]);
}
